...
namespace Jaguar
{
	...
	Collision_Info Clipping_Check_Face(Mesh_Hitbox* Hitbox_A, Mesh_Hitbox* Hitbox_B)
	{
		// Hitbox_A will be clipped against the faces of Hitbox_B. If there are no points left, there is no intersection.
